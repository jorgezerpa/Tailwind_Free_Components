...
export const Navbar3 = () => {
  return (
    <div className='px-4 py-2'>
        <div className='flex justify-between items-center bg-gradient-to-br from-blue-500 to-blue-800 rounded-3xl px-5 sm:px-10 py-2 shadow-md shadow-black'>
            {/* logo  */}
